...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("视频转码工具+支持AVS3")
    ...
    def _show_about(self):
        ...
        QMessageBox.about(
            ...
            "关于 视频转码工具",
            """<h2>视频转码工具 1.4</h2>
            <p>徐某的视频转码软件 (2026年2月20日)</p>
            <p>基于 Python + PyQt6 + ffmpeg-8.0.1</p>
            <p>支持 GPU 加速、批量转码、多线程处理</p>
            <p>集成 AVS3 解码支持，就为了转码8K春晚！</p>
            <hr>
            <pre>就是写着玩儿，所有功能用命令行基本上都能实现，就是懒得自己写，所以才写个前端出来。</pre>
...
def main():
    ...
    app.setApplicationName("视频转码工具+支持AVS3")
